...
export const paidOperations = media.table(
  "paid_operations",
  {
    ...
    lifecycleVersion: numeric("lifecycle_version", { precision: 78, scale: 0 }).notNull().default("0"),
    recoveryOwner: text("recovery_owner"),
    recoveryLeaseExpiresAt: timestamp("recovery_lease_expires_at", { withTimezone: true }),
  ...
  (t) => [
    ...
    index("paid_operations_recovery_claim").on(t.recoveryLeaseExpiresAt, t.nextRetryAt, t.updatedAt),
