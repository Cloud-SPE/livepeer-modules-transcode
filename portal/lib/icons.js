// Source: livepeer-modules-open-clearinghouse/web/portal/lib/icons.js (6a6392a)
...
const base = (path) => svg`<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">${path}</svg>`;
